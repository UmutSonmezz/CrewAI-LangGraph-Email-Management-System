...
class EmailFilterCrew():
    ...
    def kickoff(self,state):
        ...
        crew=Crew(
                ...
                tasks=[
                    tasks.filter_email_task(self.filter_agent,self.__format__emails(state['emails'])),
                    tasks.action_required_emails_tasks(self.action_agent),
    ...
    def __format__emails(self, emails) :
        emails_string=[]
        for email in emails:
            print(email)
            arr=[
