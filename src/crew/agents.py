...
class EmailFilterAgents():
    def __init__(self):
        self.gmail = GmailToolkit()
            ...
            #GELEN E-POSTALARI FİLTRELEMEK İÇİN KULLANILACAK AGENT
    def email_filter_agent(self):
        return Agent(
            ...
            #EYLEM GEREKTİREN E POSTALARI ACİLİYET VE ÖNEMİNE GÖRE BELİRLEYEN AGENT
    def email_action_agent(self):
        return Agent(
            ...
            #E-POSTALARA DOĞRU VE MANTIKLI CEVAP YAZAN AGENT
